...
list = 1000:500:m;
int_list = [1 10 20 50 100 500];
beta_list = [int_list list];
[f, p] = size(beta_list);
...
data = [t_alg(1), t_alg(2), t_alg(3), t_alg(4), t_alg(5), t_alg(6), beta_list'];
xlswrite(['gaussian_',sprintf('%d',delta),'.xlsx'],data,'Time vs Beta');
